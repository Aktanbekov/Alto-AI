    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 space-y-6 sm:space-y-8">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">1. Information We Collect</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">2. How We Use Your Information</h2>
            <p className="text-stone-700 leading-relaxed mb-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">3. Data Storage and Security</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">4. Data Sharing</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">5. Your Rights</h2>
            <p className="text-stone-700 leading-relaxed mb-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">6. Cookies and Tracking</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">7. Children's Privacy</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">8. Changes to This Policy</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">9. Contact Us</h2>
            <p className="text-stone-700 leading-relaxed">
