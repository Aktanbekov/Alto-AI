  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6 text-center">
          Terms of Service
        </h1>
        <p className="text-center text-stone-700 mb-8">Last updated: January 2025</p>

        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 space-y-6 sm:space-y-8">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">1. Acceptance of Terms</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">2. Use of Service</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">3. Account Registration</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">4. Service Availability</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">5. AI Feedback Disclaimer</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">6. Intellectual Property</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">7. User Content</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">8. Limitation of Liability</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">9. Termination</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">10. Changes to Terms</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">11. Contact Information</h2>
            <p className="text-stone-700 leading-relaxed">
