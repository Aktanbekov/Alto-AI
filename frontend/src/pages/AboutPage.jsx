    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 space-y-6 sm:space-y-8">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Our Technology</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Privacy & Security</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Get Started</h2>
            <p className="text-stone-700 leading-relaxed mb-4">
