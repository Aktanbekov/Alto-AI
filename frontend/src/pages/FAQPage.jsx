    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 space-y-6 sm:space-y-8">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">What is AI Interviewer?</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">How does it work?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Is it free?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">What types of questions are asked?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">How accurate is the feedback?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Can I practice multiple times?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Is my data secure?</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-3">Do I need to verify my email?</h2>
            <p className="text-stone-700 leading-relaxed">
