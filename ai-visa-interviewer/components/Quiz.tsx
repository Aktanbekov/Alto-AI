...
export const Quiz: React.FC<QuizProps> = ({ onComplete, onCancel }) => {
  ...
  const renderInput = (label: string, field: keyof UserProfile, placeholder: string, type: 'text' | 'select' = 'text', options: string[] = []) => (
    <div className="mb-4">
    ...
    <div className="max-w-2xl mx-auto w-full">
      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-gray-100">
          <Button onClick={handleBack} variant="ghost" className="px-0 text-gray-500">
          ...
          <Button onClick={handleNext} variant="primary">
            ...
            {currentStep === STEPS.length - 1 && <Check size={18} className="ml-2" />}
          </Button>
        </div>
      </div>
    </div>
